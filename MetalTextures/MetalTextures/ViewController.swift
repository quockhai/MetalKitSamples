...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        let metalView = MetalView(frame: .zero, device: MTLCreateSystemDefaultDevice(), imageName: "backgroundImage.jpg")
//        let metalView = MetalView(frame: .zero, device: MTLCreateSystemDefaultDevice(), imageName: "apple.png")
